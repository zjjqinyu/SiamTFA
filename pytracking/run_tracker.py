...
def main():
    ...
    parser.add_argument('--tracker_name', type=str, default='siamtfa', help='Name of tracking method.')
    parser.add_argument('--tracker_param', type=str, default='siamtfa', help='Name of parameter file.')
